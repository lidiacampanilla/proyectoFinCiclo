...
if (
  isset($_POST['dni']) && ($_POST['email']) && ($_POST['nombre']) && ($_POST['apellidos'])
  ...
  try {
    ...
    //Vamos a validar el DNI mediante una funcion que hemos creado en la biblioteca de funciones
    if (!validarDNI($dni)) {
      //Lanzamos una excepcion
      throw new Exception("El DNI no es valido");
    }

    //Validamos el IBAN mediante una funcion que hemos creado en la biblioteca de funciones
    ...
    $baseDatos = 'cofradia';
    $tabla = 'usuario';
    //Llamamos a la funcion insertar que hemos creado en la biblioteca de funciones
    //para insertar los datos del usuario en la tabla Usuario
    ...
    $tablaPer = 'pertenecen';
    //Llamamos a la funcion insertar que hemos creado en la biblioteca de funciones
    //para insertar los datos del usuario en la tabla Pertenecen
